...
- **Última Tarea:** Finalización del laboratorio "Fix the Code" (Módule 2).
- **Próxima Tarea:** Crear componente base del Mapa de Misiones.
...
- [ ] **Mapa de Misiones (`MissionMap.jsx`):** Renderizar nodos estilo videojuego con estados (bloqueado/desbloqueado/estrellas) vinculados al XP del usuario.
